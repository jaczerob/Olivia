...
public class ToonHQToon {
    ...
    private int laff = 0;
    private int toonup = 0;
    private int trap = 0;
    private int lure = 0;
    private int sound = 0;
    @JsonProperty("throw")
    private int throwGag = 0;
    private int squirt = 0;
    private int drop = 0;
    ...
    public boolean is(final ToonHQToonRef ref) {


        return this.name.equalsIgnoreCase(ref.name()) &&
                this.species.equalsIgnoreCase(ref.species()) &&
                this.laff >= ref.laff();
    }
}